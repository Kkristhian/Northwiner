...
?>
    <form action="territorio-update.php" method="POST">
        <div class="form-group">
            ...
            <input type="number" name="IDTerritorio" id="IDTerritorio"  class="form-control" value="<?=$_GET['IDTerritorio']?>">
        </div>
        <div>
            <label for="DescricaoTerritorio">Descrição Território:</label>
            <input type="text" name="DescricaoTerritorio" id="DescricaoTerritorio" required class="form-control"">
        </div>
